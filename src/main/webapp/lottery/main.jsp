...
<div class="container">
    ...
    <form action="lotteryController.do" method="GET">
        <div class="mb-3">
            ...
            <input type="number" id="group" name="group" class=class="form-control" value="${ param.group }" />
            <div id="groupHelp" class="form-text">輸入您要的組數</div>
        </div>
        <div class="mb-3">
            <lable id="excludelabel" name="lable" class="form-label">排除的數字</lable>
            <input type="text" id="exclude" name="exclude" class=class="form-control" value="${ param.exclude}" />
